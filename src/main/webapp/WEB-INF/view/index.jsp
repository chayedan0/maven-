		...
		<div class="row">
			...
			<div class="col-md-2" style="max:200px;margin-top:20px" >
					...
					<ul class="list-group menu">
						<li class="list-group-item active" data="index">热门文章</li>
				...
				<div id="myCarousel" class="carousel slide" style="minheight:200px">
						...
						<div class="carousel-inner thumbnail" style="border-radius:12px;">
							<div class="item active">
								<img  class="img-rounded"  src="/resource/images/turan.jpg" style=" border-radius:24px; align:center;width:800px; height:400px;" alt="First slide">
							</div>
							<div  class="item">
								<img  class="img-rounded" src="/resource/images/xuexi.jpg"  style="border-radius:24px;width:800px; height:400px;" alt="Second slide">
							</div>
							<div class="item">
								<img  class="img-rounded" src="/resource/images/zuoti.jpg" style="border-radius:24px; width:800px; height:400px;" alt="Third slide">
							</div>
						</div>
						<!-- 轮播（Carousel）导航 -->
